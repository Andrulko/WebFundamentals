...
<img src="images/http-request.png"  alt="Requête HTTP" />
...
<img src="images/http-cache-control.png"  alt="Exemple de Cache-Control HTTP" />
...
Note: Conseil : le projet HTML5 Boilerplate contient des [exemples de fichiers de configuration](https://github.com/h5bp/server-configs) pour tous les serveurs les plus populaires, ainsi que des commentaires détaillés pour chaque indicateur et paramètre de configuration : recherchez votre serveur de prédilection dans la liste, recherchez les paramètres concernés, et copiez les paramètres recommandés ou vérifiez qu'ils sont configurés pour votre serveur.
...
<img src="images/http-cache-control-highlight.png"  alt="Exemple de Cache-Control HTTP" />
...
<img src="images/http-cache-decision-tree.png"  alt="Arborescence de décision du cache" />
...
<thead>
  <tr>
    <th colspan="2">Directives Cache-Control</th>
  </tr>
</thead>
<tr>
  <td data-th="cache-control">max-age=86400</td>
  <td data-th="explanation">La réponse peut être mise en cache par le navigateur et tout cache intermédiaire (elle est donc 'publique') pendant un maximum de 1 jour (60 secondes x 60 minutes x 24 heures)</td>
</tr>
<tr>
  <td data-th="cache-control">private, max-age=600</td>
  <td data-th="explanation">La réponse ne peut être mise en cache que par le navigateur du client pendant un maximum de 10 minutes (60 secondes x 10 minutes)</td>
</tr>
<tr>
  <td data-th="cache-control">no-store</td>
  <td data-th="explanation">La réponse n'est pas autorisée à être mise en cache et doit être récupérée en intégralité à chaque requête.</td>
</tr>
</table>
...
<img src="images/http-cache-hierarchy.png"  alt="Hiérarchie du cache" />
