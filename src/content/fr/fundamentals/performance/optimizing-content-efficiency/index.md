project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: La quantité de données téléchargée par chaque application ne cesse d'augmenter. Pour offrir d'excellentes performances, nous devons optimiser la livraison de chaque octet !
...
<img src="images/http-archive-trends.png"  alt="Tendances HTTP Archive" />
