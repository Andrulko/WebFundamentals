project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: Удалив все ненужные ресурсы, перейдем к следующем шагу - уменьшению размера оставшихся скачиваемых данных, то есть к сжатию с помощью базовых и специфических алгоритмов GZip.
...
<img src="images/transfer-vs-actual-size.png"
  alt="Сравнение фактического размера ресурса и размера при передаче в Инструментах разработчика" />
