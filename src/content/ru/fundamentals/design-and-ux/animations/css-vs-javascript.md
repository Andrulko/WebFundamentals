project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: Для создания анимации можно использовать CSS или JavaScript. Какой из вариантов выбрать и почему?
