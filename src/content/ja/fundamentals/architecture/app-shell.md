project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: App Shell アーキテクチャでは UI をローカルに保持して、ウェブのリンク可能性と見つけやすさを損なうことなくコンテンツを動的に読み込むことができます。
