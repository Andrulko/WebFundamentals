project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: 幅広いユーザーや端末を対象にする場合、レイアウトやグラフィックだけでなく、コンテンツについても配慮が必要です。
...
> 
> 教養のある、専門知識の豊富な人ほど、 わかりやすい英語をより好みます。
...
ウェブページは拡大の一途をたどっています。  
  
[HTTP Archive](http://httparchive.org/trends.php#bytesTotal&reqTotal) によると、[上位 100 万位までのサイト](http://httparchive.org/about.php#listofurls)における、ページのデータ量の平均は 2 MB を超えています。
