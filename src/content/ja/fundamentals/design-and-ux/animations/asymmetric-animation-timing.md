project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: 対称性を破ることで、プロジェクトにコントラストと魅力を与えます。プロジェクトで非対称のアニメーションを使う場面と、その方法について学習します。
