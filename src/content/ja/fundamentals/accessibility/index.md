project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: ウェブページのアクセシビリティの改善
...
アクセシビリティとそのスコープや影響を理解できると、より優れたウェブ デベロッパーになることができます。 このガイドを通じて、すべてのユーザーにとってアクセスしやすく使いやすいウェブサイトを構築する方法を理解することができます。
...
もちろん、まったくそんなことはありません。他の話題に移る前に、この点を明確にしておきましょう。 アクセシビリティとはどういうものでしょうか。これから何を学ぶのでしょうか。
...
このガイドでは、[Web Content Accessibility Guidelines (WCAG) 2.0](https://www.w3.org/TR/WCAG20/){: .external } を参照します。これは、アクセシビリティのエキスパートによって、「アクセシビリティ」の意味を系統的に説明するためにまとめられたガイドラインとベスト プラクティスのセットです。
...
- [**フォーカス**](/web/fundamentals/accessibility/focus):マウスの代わりにキーボードで操作できる機能を構築する方法について説明します。 これは、運動障がいのあるユーザーにとって重要であり、当然ながら、すべてのユーザーにとって使いやすい UI を作成することにもつながります。
