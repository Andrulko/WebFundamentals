project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: 최초 HTML이 안전한 HTTPS 연결을 통해 로드될 때 혼합이 발생하지만 다른 리소스는 안전하지 않은 HTTP 연결을 통해 로드됩니다.
