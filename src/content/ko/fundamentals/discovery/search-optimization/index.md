project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: 웹사이트는 사람만 방문하는 곳이 아닙니다. 실은 검색 엔진 웹 크롤러도 방문하는 곳이죠. 웹사이트의 검색 정확도와 순위를 높이는 방법을 자세히 알아보세요.
