project_path: /web/fundamentals/_project.yaml book_path: /web/fundamentals/_book.yaml description: Un análisis exhaustivo sobre el ciclo de vida del service worker
