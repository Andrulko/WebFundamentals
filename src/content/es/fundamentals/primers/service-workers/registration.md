project_path: /web/fundamentals/_project.yaml book_path: /web/fundamentals/_book.yaml description: Recomendaciones para saber cuándo registrar un service worker.
