project_path: /web/fundamentals/_project.yaml book_path: /web/fundamentals/_book.yaml description: Asegúrate de obtener el mejor rendimiento posible de la implementación de service worker.
