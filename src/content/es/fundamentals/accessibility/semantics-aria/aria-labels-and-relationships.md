project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: Uso de etiquetas ARIA para crear descripciones de elementos accesibles
