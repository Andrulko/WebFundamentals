project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: Uso del atributo alt para brindar alternativas de texto para imágenes
