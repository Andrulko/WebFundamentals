project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: Obtén información acerca de cómo el navegador construye los árboles del DOM y el CSSOM.
