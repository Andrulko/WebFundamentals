...
<img src="images/css-vs-device-pixels.png"  alt="CSS-pixels en apparaatpixels" />
...
<img src="images/artifacts.png"  alt="Vervorming door compressie" />
...
Het menselijk oog is niet voor elke kleur even gevoelig: we kunnen het spectrum voor de betreffende kleuren vergroten of verkleinen om onze kleurcodering te optimaliseren. Naburige pixels vormen een tweedimensionaal raster. Dit betekent dat pixels meerdere buren hebben. We kunnen dit feit gebruiken om deltacodering verder te verbeteren. We hoeven niet per se naar de directe buren van elke pixel te kijken, maar kunnen ons concentreren op grotere blokken naburige pixels en verschillende blokken verschillend coderen. Enzovoorts...
...
<img src="images/save-for-web.png" class="attempt-right" alt="Opslaan voor internet" />
...
<img src="images/format-tree.png"  alt="Opslaan voor internet" />
...
2. **Wilt u fijne details behouden met de hoogste resolutie? Gebruik PNG.** 
...
3. **Wilt u een foto, screenshot of vergelijkbaar afbeeldingitem optimaliseren? Gebruik dan JPEG.** 
...
<tr>
  ...
  <td data-th="description">GIF-afbeeldingen maken en optimaliseren</td>
</tr>
<tr>
  <td data-th="tool"><a href="http://jpegclub.org/jpegtran/">jpegtran</a></td>
  <td data-th="description">JPEG-afbeeldingen optimaliseren</td>
</tr>
<tr>
  <td data-th="tool"><a href="http://optipng.sourceforge.net/">optipng</a></td>
  <td data-th="description">PNG-optimalisatie zonder verlies</td>
</tr>
<tr>
  <td data-th="tool"><a href="http://pngquant.org/">pngquant</a></td>
  <td data-th="description">PNG-optimalisatie met verlies</td>
</tr>
</table>
