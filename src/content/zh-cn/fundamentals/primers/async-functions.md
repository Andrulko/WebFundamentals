project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description:异步函数用于像编写同步代码那样编写基于 Promise 的代码
...
是的，没错，我使用 `reduce` 来链接 Promise 序列。我是不是*很智能*。 但这种有点*很智能*的编码还是不要为好。
