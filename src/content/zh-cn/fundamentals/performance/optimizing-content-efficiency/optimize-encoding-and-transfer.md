project_path: /web/fundamentals/_project.yaml book_path: /web/fundamentals/_book.yaml description:除了避免不必要的资源下载，在提高网页加载速度上我们可以采取的最有效措施就是，通过优化和压缩其余资源来最大限度减小总下载大小。
