project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: Otimizar o caminho crítico de renderização é priorizar a exibição do conteúdo relacionado à ação atual do usuário.
