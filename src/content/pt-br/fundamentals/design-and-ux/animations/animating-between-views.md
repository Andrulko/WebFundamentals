project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: Saiba como criar uma animação entre duas visualizações em seus aplicativos.
