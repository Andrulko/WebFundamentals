...
{# wf_updated_on: 2017-10-06 #} {# wf_published_on: 2016-09-27 #}
...
<h2 class="nope">Notificações push na Web, uma nova forma de envolver usuários {: .hide-from-toc  }</h2>
...
As notificações push na Web facilitam envolver novamente os usuários mostrando notificações relevantes, oportunas e contextuais ao usuário, mesmo quando o navegador está fechado.
