project_path: /web/_project.yaml book_path: /web/fundamentals/_book.yaml description: Web'in çogunlugu bu çoklu cihaz deneyimleri için optimize edilmemistir. Sitenizin mobil cihazlarda, masaüstü bilgisayarlarda veya ekrani olan herhangi bir seyde çalismasini saglamak için gereken temel bilgileri edinin.
...
<table class="responsive">
  <thead>
    <tr>
      <th colspan="2">özellik</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td data-th="attribute"><code>min-width</code></td>
      <td data-th="Result">Kurallar, genisligi sorguda tanimlanan degerin üzerinde olan tarayicilar için uygulanir.</td>
    </tr>
    <tr>
      <td data-th="attribute"><code>max-width</code></td>
      <td data-th="Result">Kurallar, genisligi sorguda tanimlanan degerin altinda olan tarayicilar için uygulanir.</td>
    </tr>
    <tr>
      <td data-th="attribute"><code>min-height</code></td>
      <td data-th="Result">Kurallar, yüksekligi sorguda tanimlanan degerin üzerinde olan tarayicilar için uygulanir.</td>
    </tr>
    <tr>
      <td data-th="attribute"><code>max-height</code></td>
      <td data-th="Result">Kurallar, yüksekligi sorguda tanimlanan degerin altinda olan tarayicilar için uygulanir.</td>
    </tr>
    <tr>
      <td data-th="attribute"><code>orientation=portrait</code></td>
      <td data-th="Result">Kurallar, yüksekligin genislikten büyük veya genislige esit oldugu tarayicilar için uygulanir.</td>
    </tr>
    <tr>
      <td data-th="attribute"><code>orientation=landscape</code></td>
      <td data-th="Result">Kurallar, genisligin yükseklikten büyük oldugu tarayicilar için uygulanir.</td>
    </tr>
  </tbody>
</table>
...
- Tarayici genisligi **0p** ile **640p** arasinda oldugunda, `max-640px.css` uygulanir.
- Tarayici genisligi **500p** ile **600p** arasinda oldugunda, `@media` içindeki stiller uygulanir.
- Tarayici genisligi **640p veya daha fazla** oldugunda, `min-640px.css` uygulanir.
- Tarayici **genisligi yükseklikten fazla oldugunda**, `landscape.css` uygulanir.
- Tarayici **yüksekligi genislikten fazla oldugunda**, `portrait.css` uygulanir.
...
Baslangiçta gördügümüz [hava durumu tahmini](/web/fundamentals/design-and-ux/responsive/) örnegi üzerinden çalismaya baslayalim. Ilk adimimiz, tahminin küçük bir ekranda iyi görünmesini saglamak olacak.
...
<div class="attempt-left">
  <figure>
    <img src="imgs/weather-4-l.png" srcset="imgs/weather-4-l.png 1x, imgs/weather-4-l-2x.png 2x" alt="Küçük kesme noktalari eklemeden önce.">
...
<div class="attempt-right">
  <figure>
    <img src="imgs/weather-4-r.png" srcset="imgs/weather-4-r.png 1x, imgs/weather-4-r-2x.png 2x" alt="Küçük kesme noktalari ekledikten sonra.">
